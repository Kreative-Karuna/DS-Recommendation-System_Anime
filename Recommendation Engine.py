...
# import Dataset 
anime = pd.read_csv(r"C:\Users\Karuna Singh\Downloads\Mar.23\Deployment\Recommendation Engine\anime.csv", encoding = 'utf8')

# Database Connection
from sqlalchemy import create_engine

engine = create_engine("mysql+pymysql://{user}:{pw}@localhost/{db}".format(user = "root", pw = "WorkBench1", db = "recommenddb1"))
